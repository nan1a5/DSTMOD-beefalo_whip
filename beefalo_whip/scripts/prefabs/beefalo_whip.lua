local assets =
{
    Asset("ATLAS", "images/beefalo_whip.xml"),
    Asset("IMAGE", "images/beefalo_whip.tex"),
    Asset("ANIM", "anim/beefalo_whip_onbank.zip"),
    Asset("ANIM", "anim/swap_beefalo_whip.zip"),
}

local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_beefalo_whip", "swap_beefalo_whip")
...
local function fn()
    ...
    inst.AnimState:SetBank("beefalo_whip_onbank")
    inst.AnimState:SetBuild("beefalo_whip_onbank")
    inst.AnimState:PlayAnimation("idle")

    inst:AddTag("whip")
    inst:AddTag("beefalo_whip")
    ...
    inst.components.inventoryitem.imagename = "beefalo_whip"
    inst.components.inventoryitem.atlasname = "images/beefalo_whip.xml"
...
return Prefab("beefalo_whip", fn, assets)
